    ...
    <footer className="bg-black">
      <div className="w-full p-4 flex flex-col sm:flex-row items-center justify-between">
        <div className="flex flex-row space-x-3 sm:space-x-4">
          ...
          <Link href="https://github.com/zorenal" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 496 512"
              height="24"
        ...
        <ul className="flex space-x-3 sm:space-x-4 mt-4 sm:mt-0 text-sm text-white">
          ...
          <li>
            <Link href="https://www.opentable.com/">Reserve</Link>
          </li>
        </ul>
      </div>
      <hr className="border-white"/>
      <span className="flex justify-center text-sm text-white sm:text-center m-4">
        © 2024{' '}<Link href="/">Zoren™</Link>. All Rights Reserved.
      </span>
    </footer>
  );
}
