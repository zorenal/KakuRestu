...
export default function Navbar() {
  ...
  return (
    <nav className={` w-full flex items-center justify-between z-50 text-md sm:text-xl font-bold transition-all duration-300 text-white ${scrolled ? " fixed top-0 left-0 p-5  bg-black bg-opacity-90 " : "absolute top-0 p-8 bg-black bg-opacity-20 text-shadow"}`}>
      {/* Larger Screens */}
